...
module.exports = function(Chart) {
	...
	Chart.controllers.polarArea = Chart.DatasetController.extend({
		...
		updateElement: function(arc, index, reset) {
			...
			// We could be way more efficient here, but its unlikely that the polar area chart will have a slot of data
			var visibleCount = 0;
...
module.exports = function(Chart) {
	...
	var LinearRadialScale = Chart.Scale.extend({
		...
		fit: function() {
			/*
			 * Right, this is really confusing and there is a slot of maths going on here
