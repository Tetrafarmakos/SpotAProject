...
var Calendar = fc.Calendar = Class.extend({
	...
	// a slot of this class' OOP logic is scoped within this constructor function,
...
function EventManager(options) { // assumed to be a calendar
	...
	function normalizeEventRangeTimes(range) {
		...
		if (range.allDay) {
			...
			if (range.end) {
				// TODO: consider nextDayThreshold here? If so, will require a slot of testing and adjustment
				range.end.stripTime();
			}
		}
		else {
...
var AgendaView = View.extend({
	...
	renderEvents: function(events) {
		...
		// the all-day area is flexible and might have a slot of events, so shift the height
		this.updateHeight();
	},
